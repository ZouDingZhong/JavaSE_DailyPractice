...
<div id="jive-forumpage">
  ...
  <div class="jive-buttons">
    <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          <td class="jive-icon"><a href="reply.jsp?id=0&rootid=2"><img src="images/post-16x16.gif" alt="发表新主题" border="0" height="16" width="16"></a></td>
          <td class="jive-icon-label"><a id="jive-post-thread" href="reply.jsp?id=0&rootid=<%= count %>" onClick="addCounter()">发表新主题</a> <a href="reply.jsp"></a></td>
        </tr>
      </tbody>
    </table>
  </div>
                ...
                <%
                  ...
                  <tr class="jive-even">
                    ...
                    <td class="jive-last" nowrap="nowrap" width="1%"><div class="jive-last-post"><%= a.getPdate() %>><br>
                        by: <a href="http://bbs.chinajavaworld.com/thread.jspa?messageID=780182#780182" title="hehe" style="">呵呵哒 &#187;</a> </div></td>
                  </tr>
                  <%--
                  <tr class="jive-odd">
                    <td class="jive-first" nowrap="nowrap" width="1%"><div class="jive-bullet"> <img src="images/read-16x16.gif" alt="已读" border="0" height="16" width="16">
